    ...
    with tf.Session() as sess:
        ...
        for e in range(args.num_epochs):
            ...
            for b in range(data_loader.num_batches):
                ...
                x, y, d, x_grid,fr_ped = data_loader.next_batch()
                ...
                for batch in range(data_loader.batch_size):
                    ...
                    x_batch, y_batch, d_batch, x_batch_grid, ped_fr_batch = x[batch], y[batch], d[batch], x_grid[batch], fr_ped[batch]
                    dataset_data = [720, 576]
                    grid_batch = getSequenceGridMask(x_batch_grid, dataset_data, args.neighborhood_size, args.grid_size)
