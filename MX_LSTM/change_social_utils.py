...
class SocialDataLoader():
    ...
    def frame_preprocess(self, data_dirs, data_file):
        ...
        for directory in data_dirs:
            ...
            file_path = os.path.join(directory, 'merged_zero_norm.csv')
            ...
            all_frame_grid_data.append(np.zeros((numFrames - valid_numFrames, self.maxNumPeds, 3)))
            ...
            for ind, frame in enumerate(frameList):
                ...
                for ped in pedsList:
                    ...
                    gridLocsNorm.append([ped, grid_x, grid_y])
    ...
    def next_batch(self, randomUpdate=True):
        ...
        while i < self.batch_size:
            ...
            if idx + self.seq_length < frame_data.shape[0]:
                ...
                sourceGridData = np.zeros((self.seq_length, self.maxNumPeds, 3))
