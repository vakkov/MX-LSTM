...
class LogCholSocialModel():
        ...
        for seq, frame in enumerate(frame_data):
            ...
            for ped in range(args.maxNumPeds):
                ...
                with tf.name_scope("get_coef"):
                    ...
                    [o_mux, o_muy, o_mux_prime, o_muy_prime, o_a11,o_a21,o_a22,o_a31,o_a32,o_a33,o_a41,o_a42,o_a43,o_a44] = self.get_coef(self.initial_output[ped])

                with tf.name_scope("calculate_loss"):
                    # Calculate loss for the current ped
                    lossfunc = self.get_lossfunc(o_mux, o_muy, o_mux_prime, o_muy_prime, o_a11,o_a21,o_a22,o_a31,o_a32,o_a33,o_a41,o_a42,o_a43,o_a44,x_data, y_data,x_prime,y_prime)
    ...
    def tf_Nd_normal(self,x, y, x_prime, y_prime, mux, muy, mux_prime, muy_prime, a11, a21, a22, a31, a32, a33, a41, a42,a43, a44):
    ...
    def get_lossfunc(self, z_mux, z_muy,z_mux_prime, z_muy_prime, a11, a21, a22, a31, a32, a33, a41, a42, a43, a44 , x_data, y_data, x_prime, y_prime):
        '''
        ...
        result0 = self.tf_Nd_normal(x_data, y_data,x_prime,y_prime,z_mux, z_muy,z_mux_prime, z_muy_prime, a11, a21, a22, a31, a32, a33, a41, a42, a43, a44)
    ...
    def sample_gaussian_2d(self, mux, muy, muvx, muvy,  a11, a21, a22, a31, a32, a33, a41, a42, a43, a44):
        '''
        ...
        return x[0][0], x[0][1], x[0][2], x[0][3], cov
    ...
    def sample(self, sess, traj, grid, dimensions, true_traj, num=10):
        ...
        for t in range(num):
            ...
            for pedindex, pedoutput in enumerate(output):
                [o_mux, o_muy, o_mux_prime, o_muy_prime, o_a11,o_a21,o_a22,o_a31,o_a32,o_a33,o_a41,o_a42,o_a43,o_a44] = np.split(pedoutput[0], 14, 0)
                mux, muy, mux_prime, muy_prime, a11, a21, a22, a31, a32, a33, a41, a42, a43, a44 = o_mux[0], o_muy[0], o_mux_prime[0], o_muy_prime[0], o_a11[0],o_a21[0],o_a22[0],o_a31[0],o_a32[0],o_a33[0],o_a41[0],o_a42[0],o_a43[0],o_a44[0]



                next_x, next_y, next_x_prime, next_y_prime, cov = self.sample_gaussian_2d(mux, muy, mux_prime, muy_prime, a11, a21, a22, a31, a32, a33, a41, a42, a43, a44)
